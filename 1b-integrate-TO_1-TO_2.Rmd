...
#Normalization and Variable Features for dataset 2 (2D H841)
...
FeaturePlot(data.combined, features = c("YAP1", "HES1"), blend = TRUE, reduction="umap")
